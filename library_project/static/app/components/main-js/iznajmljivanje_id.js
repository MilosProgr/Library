...
<p class="fond"><b>-Izmena iznajmljivanja</b></p>
<div class="mb-3">
    <label class="form-label fond">Kupac ID: </label>
    ...
    <div class="form-text"><i class="placeh tekst">Izaberi kupca</i></div>
</div>
<div class="mb-3">
    <label class="form-label fond">Knjiga ID: </label>
    ...
    <div class="form-text"><i class="placeh tekst">Izaberi knjigu</i></div>
</div>
<div class="mb-3">
    <label class="form-label fond">Količina: </label>
    <input type="number" class="form-control" v-model="iznajmiti.kolicina" required>
    <div class="form-text"><i class="placeh tekst">Izmeni količinu</i></div>
</div>
<div class="mb-3">
    <label class="form-label fond">Način plaćanja: </label>
    <input type="text" class="form-control" v-model="iznajmiti.nacinPlacanja" required>
    <div class="form-text"><i class="placeh tekst">Izmeni način plaćanja</i></div>
</div>
<div class="mb-3">
    <label class="form-label fond">Valuta: </label>
    <input type="text" class="form-control" v-model="iznajmiti.valuta" required>
    <div class="form-text"><i class="placeh tekst">Izmeni valutu</i></div>
</div>
<div class="mb-3">
    <label class="form-label fond">Period iznajmljivanja: </label>
    <input type="text" class="form-control" v-model="iznajmiti.periodIznajmljivanja" required>
    <div class="form-text"><i class="placeh tekst">Izmeni period iznajmljivanja(broj dana)</i></div>
</div>
<div class="mb-3">
    <label class="form-label fond">Datum porudžbine: </label>
    <input type="datetime-local" class="form-control" v-model="iznajmiti.datumPorudzbine" required>
    <div class="form-text"><i class="placeh tekst">Izmeni datum porudžbine</i></div>
</div>
<div>
