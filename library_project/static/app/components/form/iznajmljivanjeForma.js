...
<div class="mb-3">
    ...
    <div class="form-text"><i class="placeh tekst">Uneti količinu</i></div>
</div>
<div class="mb-3">
    ...
    <div class="form-text"><i class="placeh tekst">Uneti način plaćanja</i></div>
</div>
<div class="mb-3">
    <label class="form-label fond">Valuta: </label>
    <input type="text" class="form-control" v-model="novaIznajmljivanja.valuta" required>
    <div class="form-text"><i class="placeh tekst">Uneti valutu</i></div>
</div>
<div class="mb-3">
    ...
    <div class="form-text"><i class="placeh tekst">Uneti period iznajmljivanja(broj dana)</i></div>
</div>
<div class="mb-3">
    ...
    <div class="form-text"><i class="placeh tekst">Uneti datum porudžbine</i></div>
</div>
<div>
